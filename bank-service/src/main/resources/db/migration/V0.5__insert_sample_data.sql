...
INSERT INTO card (id, card_number, preferred_auth_id, balance, version)
VALUES (nextval('card_id_seq'), '1111222233334444', 1, 11.22, 1);
INSERT INTO card (id, card_number, preferred_auth_id, balance, version)
VALUES (nextval('card_id_seq'), '1234567812345678', 1, 1001.01, 1);
INSERT INTO card (id, card_number, preferred_auth_id, balance, version)
VALUES (nextval('card_id_seq'), '4444333322221111', 2, 0.00, 1);
