...
class FingerprintValidationServiceImplTest {
    ...
    void setUp() {
        ...
        cardValidationService = new FingerprintValidationServiceImpl(cardCredentialRepository);
    }
    ...
    void validateCredentialNotSet() {
        ...
        assertTrue(Objects.requireNonNull(exception.getMessage()).contains("Authentication method FINGERPRINT not set"));
        verify(cardCredentialRepository, times(1)).findByCard_CardNumberAndCredentialType_Id(any(), any());
    }
